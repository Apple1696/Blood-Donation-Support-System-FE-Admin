...
export default function StaffProfile() {
    ...
    React.useEffect(() => {
        const fetchProfile = async () => {
            try {
                const data = await profileService.getCurrentStaffProfile()
                setProfile(data)
            } catch (error) {
    ...
    // Update form values only when profile is available
    React.useEffect(() => {
        if (profile) {
            form.reset(profile)
        }
    ...
    const onSubmit = async (data: FormData) => {
        try {
            await profileService.updateCurrentStaffProfile(data)
            setProfile(data)
            setIsEditing(false)
